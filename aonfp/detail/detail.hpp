...
template <class T>
constexpr T get_nan_exponent(T v) {return (static_cast<T>(1) << (sizeof(T) - 1)) - 1;}

template <class T>
constexpr T get_nan_mantissa(T v) {return ~static_cast<T>(0);}

template <class T>
constexpr T get_inf_exponent(T v) {return get_nan_exponent<T>(0) | (v & (static_cast<T>(1) << (sizeof(T) - 1)));}

template <class T>
constexpr T get_inf_mantissa() {return static_cast<T>(0);};

template <class T>
constexpr T get_zero_exponent(T v) {return (static_cast<T>(1) << (sizeof(T) - 1)) & v;}
