...
int copy_to_device(T* const dst_ptr, const EXP_T* const exp_ptr, const S_MANTISSA_T* const s_mantissa_ptr, const std::size_t N, const bool set_cpu_affinity_frag = true, cudaStream_t stream = 0);

template <class EXP_T, class S_MANTISSA_T, class T>
int copy_to_host(EXP_T* const exp_ptr, S_MANTISSA_T* const s_mantissa_ptr, const T* const dst_ptr, const std::size_t N, const bool set_cpu_affinity_frag = true, cudaStream_t stream = 0);
} // namespace q
} // namespace cuda
} // namespace aonfp
#endif
