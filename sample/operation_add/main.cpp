...
int main() {
	test_add<uint64_t, uint64_t, uint64_t, uint64_t>();
	test_add<uint64_t, uint32_t, uint64_t, uint32_t>();
	test_add<uint64_t, uint16_t, uint64_t, uint16_t>();
	test_add<uint64_t, uint8_t , uint64_t, uint8_t >();
	test_add<uint32_t, uint64_t, uint32_t, uint64_t>();
	test_add<uint32_t, uint32_t, uint32_t, uint32_t>();
	test_add<uint32_t, uint16_t, uint32_t, uint16_t>();
	test_add<uint32_t, uint8_t , uint32_t, uint8_t >();
	test_add<uint16_t, uint64_t, uint16_t, uint64_t>();
	test_add<uint16_t, uint32_t, uint16_t, uint32_t>();
	test_add<uint16_t, uint16_t, uint16_t, uint16_t>();
	test_add<uint16_t, uint8_t , uint16_t, uint8_t >();
	test_add<uint8_t , uint64_t, uint8_t , uint64_t>();
	test_add<uint8_t , uint32_t, uint8_t , uint32_t>();
	test_add<uint8_t , uint16_t, uint8_t , uint16_t>();
	test_add<uint8_t , uint8_t , uint8_t , uint8_t >();
}
