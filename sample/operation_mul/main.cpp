...
void test_mul() {
	...
	const auto threshold_base = 2 * std::pow(10.0f, -std::log10(2.0) * std::min<unsigned>(sizeof(DST_MANTISSA_T) * 8, aonfp::detail::standard_fp::get_mantissa_size<double>()));
